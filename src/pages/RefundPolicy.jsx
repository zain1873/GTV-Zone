...
const SECTIONS = [
  ...
  {
    id: "seller-error",
    heading: "2. Refunds for Activation or Service Errors",
    blocks: [
  ...
  {
    id: "reseller-credits",
    heading: "7. Reseller Credits",
    blocks: [
      "Reseller credits that have been used to activate a subscription are considered consumed and are not refundable.",
